...
public class PracticalTest01Var08MainActivity extends AppCompatActivity {
    ...
    protected  void onRestoreInstanceState(Bundle savedInstanceState){
        ...
        onActivityResult(corecte_string,incorecte_string,incercari_string);
    }

    public void onActivityResult(String a, String b, String c) {
        Toast.makeText(this,"Valori :" + a + " " + b + " " + c, Toast.LENGTH_LONG).show();
    }
}
